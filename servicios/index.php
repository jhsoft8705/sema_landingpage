...
<meta charset="utf-8">
    ...
    <meta name="keywords" content="instalación de medidores de luz, pozos a tierra, cámaras de seguridad, planos eléctricos, ingeniería eléctrica, mantenimiento eléctrico">
    <meta name="description" content="Descubre nuestros servicios eléctricos en Lima. Instalaciones, mantenimiento, seguridad eléctrica y más. Cotiza tu servicio hoy.">
...
<body>
    ...
    <div class="container-fluid page-header py-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-4 text-white animated slideInDown mb-4">Nuestros servicios</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    ...
                    <li class="breadcrumb-item text-primary active" aria-current="nosotros">Nuestros servicios</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="border-start border-5 border-primary ps-4">
                        ...
                        <p class="text-muted mb-0">Te ofrecemos calidad y seguridad</p>
                    </div>
    ...
    <!--Medidores de luz -->
    <div id="medidores-luz" class="container-xxl py-5">
        <div class="container">
            <div class="row g-5">
                    ...
                    <div class="h-100">
                        ...
                        <div class="border-top mt-4 pt-4">
                            ...
                            <div class="d-flex gap-3">
                                <!-- Botón Contacto -->
                                <a href="../servicios/index.php#contactanos" class="btn btn-sm text-white"
                                ...
                                <!-- Botón Descarga -->
                                <a target="_blank" href="../assets/img/Requisitos_para_medidor_de_luz.pdf" class="btn btn-sm text-gray"
    ...
    <div id="instalacion-camaras" class="container-xxl py-5">
        <div class="container">
            <div class="row g-5">
                <!-- Imagen a la izquierda -->
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
    ...
    <div id="poso-tierra" class="container-xxl py-5">
        <div class="container">
            <div class="row g-5">
                <!-- Texto a la derecha -->
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
    ...
    <div id="planos-electricos" class="container-xxl py-5">
        <div class="container">
            <div class="row g-5">
                <!-- Imagen a la izquierda -->
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
    ...
    <div id="instacion-electrica" class="container-xxl py-5">
        <div class="container">
            <div class="row g-5">
                <!-- Texto a la derecha -->
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
    ...
    <div id="servicio-ingenieria" class="container-xxl py-5">
        <div class="container">
            <div class="row g-5">
                <!-- Imagen a la izquierda -->
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
    ...
    <div id="deteccion-fugas" class="container-xxl py-5">
        <div class="container">
            <div class="row g-5">
                <!-- Texto a la derecha -->
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
    ...
    <div id="exp-licencia" class="container-xxl py-5">
        <div class="container">
            <div class="row g-5">
                <!-- Imagen a la izquierda -->
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
